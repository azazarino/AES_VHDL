...
begin
	...
	state_out(8*15 - 1 downto 8*14) <= state_in(8*11 - 1 downto 8*10); -- s1,0
	state_out(8*11 - 1 downto 8*10) <= state_in(8*7 - 1 downto 8*6); -- s1,1
	state_out(8*7 - 1 downto 8*6) <= state_in(8*3 - 1 downto 8*2); -- s1,2
	state_out(8*3 - 1 downto 8*2) <= state_in(8*15 - 1 downto 8*14); -- s1,3
	...
	state_out(8*13 - 1 downto 8*12) <= state_in(8*1 - 1 downto 0); -- s3,0
	state_out(8*9 - 1 downto 8*8) <= state_in(8*13 - 1 downto 8*12); -- s3,1
	state_out(8*5 - 1 downto 8*4) <= state_in(8*9 - 1 downto 8*8); -- s3,2
	state_out(8*1 - 1 downto 0) <= state_in(8*5 - 1 downto 8*4); -- s3,3
